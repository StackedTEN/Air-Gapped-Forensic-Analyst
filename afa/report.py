...
<style>
  ...
  * {{ box-sizing:border-box; }}
  ...
  .q {{ font-family:"Fraunces",Georgia,serif; font-size:19px; font-weight:500; margin-bottom:12px; }}
  .a {{ color:#ded2c0; margin-bottom:16px; }}
  .prov-label {{ font-family:"JetBrains Mono",ui-monospace,monospace; font-size:10px; letter-spacing:.12em;
  ...
  .tc {{ display:grid; grid-template-columns:160px 1fr auto; gap:12px; align-items:baseline;
    font-family:"JetBrains Mono",ui-monospace,monospace; font-size:12px; padding:8px 12px; background:var(--ink);
  ...
  .rc-text {{ font-family:"Fraunces",Georgia,serif; font-size:19px; line-height:1.45; margin:10px 0 0; color:#f0e6d6; }}
  .rc-h {{ font-family:"JetBrains Mono",ui-monospace,monospace; font-size:11px; letter-spacing:.1em; text-transform:uppercase;
  ...
  .step-head {{ font-family:"Fraunces",Georgia,serif; font-size:17px; color:#ede1cf; }}
  .step-ts {{ font-family:"JetBrains Mono",ui-monospace,monospace; font-size:11px; color:var(--faint); margin-left:10px; }}
  ...
  .rc-col h4 {{ font-family:"JetBrains Mono",ui-monospace,monospace; font-size:11px; letter-spacing:.08em;
    text-transform:uppercase; color:var(--muted); margin:0 0 10px; }}
  .ioc-row {{ display:flex; gap:10px; padding:6px 0; border-bottom:1px solid var(--line); font-size:12.5px; }}
  .ioc-k {{ flex:0 0 70px; color:var(--ember); font-family:"JetBrains Mono",ui-monospace,monospace; font-size:11px; }}
  ...
  .brief-wrap h2 {{ font-family:"Fraunces",Georgia,serif; font-weight:500; font-size:22px; margin:0 0 4px; }}
  .brief-tag {{ font-family:"JetBrains Mono",ui-monospace,monospace; font-size:10px; letter-spacing:.1em;
    text-transform:uppercase; color:var(--faint); }}
  pre.brief {{ font-family:"JetBrains Mono",ui-monospace,monospace; font-size:12.5px; line-height:1.6; color:#ded2c0;
  ...
  .attack-head h2 {{ font-family:"Fraunces",Georgia,serif; font-weight:500; font-size:22px; margin:0; }}
  .attack-meta {{ font-family:"JetBrains Mono",ui-monospace,monospace; font-size:11px; color:var(--faint); }}
  .matrix {{ display:flex; flex-wrap:wrap; gap:10px; }}
  .tcol {{ flex:1 1 140px; min-width:140px; }}
  .tcol h4 {{ font-family:"JetBrains Mono",ui-monospace,monospace; font-size:10px; letter-spacing:.08em;
  ...
  .cell .tid {{ display:block; font-family:"JetBrains Mono",ui-monospace,monospace; font-size:12px; font-weight:600;
    color:var(--ember); }}
  .cell .tname {{ display:block; font-size:11px; color:#d8ccba; margin-top:3px; line-height:1.3; }}
  .cell .cnt {{ font-family:"JetBrains Mono",ui-monospace,monospace; font-size:10px; color:var(--faint); }}
